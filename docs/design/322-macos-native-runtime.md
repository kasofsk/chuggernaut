...
satisfied the same way but for its `envs` field — #309 P2 landed both halves,
the record in job #483 and the `choose_placement` predicate in job #484. See [Current state](#current-state).
